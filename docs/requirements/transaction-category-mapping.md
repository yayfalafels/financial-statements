...
This page is the normative owner for category mapping requirements.
...
- The operator interface for mapping CRUD is a custom Google Sheets UI.
...
- Stage 1 maps HomeBudget expense categories to GL account codes.
